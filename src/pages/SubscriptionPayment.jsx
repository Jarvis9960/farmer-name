      ...
      <div className="verification-main">
        <div className="container verify-screen-main p-0">
          <div className="back-btn back-btn2">
            <Link to="/plus_subscription" onClick={handleBackClick}>
              <img className="profile-pic" src={BackBtn} alt="Button-Back" />
            </Link>
            <h1>Amigo GPT Plus Subscription</h1>
          </div>
          <div className="verify-section-main align-items-stretch">
            <div className="subscription-amigo-logo-main">
              <img
                className="subscription-amigo-logo"
                src={AmigoLogo}
                alt="logo"
              />
            </div>
            <h2 className="subscription-text">Amigo GPT Plus Subscription</h2>
              ...
              <div className="new_password_input enter_code">
                <div className="form-item">
                  <input
                    ...
                    required
                  />
                  <label className="info-person" htmlFor="card_number">
                    Enter Code Here
                  </label>
                </div>
              </div>
            ...
            <div className="print-continue-btn-head">
              ...
              >
                <Link to="/confirm_payment_pin">Proceed to Checkout</Link>
              </div>
            </div>
          </div>
        </div>
                ...
                <div className="form-check border-bottom px-0 custom-radio">
                  ...
                  <div className="form-check-label checkout-modal-lbl-payment">
                    ...
                    <div className="card-text-america">
                      ...
                      <div className="america-card-number">
                        <span className="america-card-active">Active</span>|
                        Card Number **** 4625
                      </div>
                    </div>
                  </div>
                ...
                <div className="form-check border-bottom px-0 custom-radio">
                  ...
                  <div className="form-check-label checkout-modal-lbl-payment">
                    ...
                    <div className="card-text-america">
                      ...
                      <div className="america-card-number">
                        <span className="america-card-inactive">Inactive</span>|
                        Card Number **** 2540
                      </div>
                    </div>
                  </div>
