      ...
      <div className="verification-main">
        <div className="container verify-screen-main p-0">
          ...
          <div className="verify-section-main align-items-stretch">
            ...
            <p className="today-text factor">
              Now Amigo GPT has a Two-Factor Authentication. Try it now to make
            ...
            <div className="notification-security-box">
              <div className="notification-security-box-sub">
                ...
                <div>
                  <h2 className="security-update-text">
            ...
            <p className="today-text factor">
              Now you can also connect Amigo GPT with multiple MasterCard &
              Visa. Try the service now.
            </p>
            <div className="notification-security-box">
              <div className="notification-security-box-sub">
                <div className="security-main">
            ...
            <p className="today-text factor">
              Update Amigo GPT now to get access to the latest features for
              easier in making online payments.
            </p>
            <div className="notification-security-box">
              <div className="notification-security-box-sub">
                <div className="security-main">
            ...
            <p className="today-text factor border-bottom-0 history-bottom">
              Your account creation is successful, you can now experience our
              services.
            </p>
          </div>
        </div>
