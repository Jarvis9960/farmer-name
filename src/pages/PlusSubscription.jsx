      ...
      <div className="verification-main">
        <div className="container verify-screen-main p-0">
          <div className="back-btn back-btn2">
            <Link to="/alert" onClick={handleBackClick}>
          ...
          <div className="verify-section-main align-items-stretch">
            <div className="main-text-group">
              <h2 className="hey-jessica gpt-plus">Amigo GPT Plus</h2>
              <div className="premium-features-main">
                ...
                <div>
                  ...
                  <p className="sub-text access">
                    Plus subscribers have access to Amigo GPT Pro and our latest
                    beta features.
                  </p>
                </div>
              </div>
              <div className="premium-features-main">
                ...
                <div>
                  ...
                  <p className="sub-text access">
                    You’ll be able to use Amigo GPT even when demand is high.
                  </p>
                </div>
              </div>
              <div className="premium-features-main">
                ...
                <div>
                  <h3>Ultra Fast</h3>
                  <p className="sub-text access">
                    Enjoy even faster response speeds when using Amigo GPT Pro.
                  </p>
                </div>
              </div>
            </div>
            <div className="print-continue-btn-head">
              <div className="block-footer until-canceled">
                <p> Auto-renews for $25/month until canceled </p>
              </div>
              <div
                className="bottom-fix-btn  onboarding-next-btn-Subscribe"
                onClick={handleSignIn}
              >
                <Link to="/subscription_payment">Subscribe</Link>
              </div>
            </div>
          </div>
        </div>
      </div>
      {/* <!-- ====================================== Plus Subscription Screen End ===================================== --> */}
    </>
  );
};
