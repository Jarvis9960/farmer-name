...
const PaymentMethod = () => {
  ...
  const [isConnectpay, setIsConnectpay] = useState(true);
  const [isConnectGoogle, setIsConnectGoogle] = useState(true);
  ...
  const toggleConnectionPay = () => {
    setIsConnectpay((prev) => !prev);
  };

  const toggleConnectionGoogle = () => {
    setIsConnectGoogle((prev) => !prev);
  };
  return (
    <>
        ...
        <div className="container verify-screen-main p-0">
          ...
          <div className="verify-section-main align-items-stretch">
                  ...
                  <span className="payment-type2">
                    ...
                    >
                      <path
                        ...
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M9.86792 2.95373C9.23506 3.72759 8.22249 4.33795 7.20992 4.25076C7.08335 3.20442 7.57909 2.09268 8.15921 1.40602C8.79206 0.610365 9.89956 0.0435975 10.7961 0C10.9016 1.08994 10.4902 2.15808 9.86792 2.95373ZM10.784 4.45784C9.89195 4.40479 9.07799 4.73507 8.42053 5.00184C7.99744 5.17352 7.63916 5.31889 7.36658 5.31889C7.0607 5.31889 6.68763 5.16574 6.26875 4.99379C5.71989 4.76848 5.09239 4.51088 4.43435 4.52324C2.92604 4.54504 1.52321 5.42789 0.75324 6.83391C-0.828899 9.64594 0.341884 13.8095 1.87129 16.0984C2.62016 17.2319 3.51671 18.4744 4.69804 18.4308C5.21775 18.4106 5.59161 18.2466 5.97851 18.077C6.42394 17.8817 6.88666 17.6788 7.60918 17.6788C8.30664 17.6788 8.74913 17.8764 9.17389 18.0661C9.57777 18.2464 9.96563 18.4197 10.5414 18.409C11.7649 18.3872 12.5349 17.2755 13.2838 16.142C14.0919 14.9254 14.4471 13.7381 14.501 13.5579L14.5073 13.537C14.506 13.5357 14.496 13.531 14.4784 13.5226C14.2083 13.3948 12.1434 12.418 12.1235 9.79853C12.1037 7.59989 13.7614 6.48592 14.0223 6.31056C14.0382 6.29989 14.0489 6.29269 14.0538 6.28894C12.999 4.67583 11.3536 4.50144 10.784 4.45784ZM19.2571 18.2891V1.29701H25.4275C28.6128 1.29701 30.8384 3.56408 30.8384 6.87749C30.8384 10.1909 28.5706 12.4798 25.3431 12.4798H21.8096V18.2891H19.2571ZM21.8084 3.52049H24.7512C26.9662 3.52049 28.2319 4.74121 28.2319 6.88839C28.2319 9.03557 26.9662 10.2672 24.7406 10.2672H21.8084V3.52049ZM39.2606 16.251C38.5856 17.5807 37.0984 18.4199 35.4951 18.4199C33.1219 18.4199 31.4659 16.9594 31.4659 14.7577C31.4659 12.5779 33.0692 11.3244 36.0331 11.1392L39.2184 10.943V10.0056C39.2184 8.6214 38.343 7.86935 36.7819 7.86935C35.4951 7.86935 34.5564 8.55601 34.3665 9.60235H32.0672C32.141 7.40067 34.145 5.79847 36.8558 5.79847C39.7775 5.79847 41.676 7.37888 41.676 9.83123V18.2891H39.3134V16.251H39.2606ZM36.1848 16.4036C34.8242 16.4036 33.9593 15.7278 33.9593 14.6924C33.9593 13.6242 34.7925 13.003 36.3852 12.9049L39.2225 12.7196V13.6787C39.2225 15.27 37.9146 16.4036 36.1848 16.4036ZM49.5151 18.954C48.492 21.9295 47.3212 22.9105 44.832 22.9105C44.6421 22.9105 44.0093 22.8887 43.8616 22.8451V20.8069C44.0198 20.8287 44.4101 20.8505 44.6105 20.8505C45.7391 20.8505 46.3719 20.36 46.7622 19.0848L46.9942 18.3327L42.6697 5.96195H45.3383L48.3443 16.0003H48.3971L51.4031 5.96195H53.9979L49.5151 18.954Z"
                      />
                    </svg>
                  </span>
                  <div className="card-text-america">
                    <div className="bank-america-text">Apply Pay</div>
                  </div>
                </div>
              </div>
              <div className="form-check border-bottom px-0 custom-radio">
                <div className="form-check-label checkout-modal-lbl-payment">
                  <h2
                    className="connect-text not-connect"
                    onClick={toggleConnectionGoogle}
                    style={{
                      color: isConnectGoogle ? "#00D061" : "#FF484D",
                      cursor: "pointer",
                    }}
                  >
                    {isConnectGoogle ? "Connected" : "Not Connected"}
                  </h2>
                  <span className="payment-type2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    >
                      <path
                        ...
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M24.9065 17.2471V10.7765H28.2742C29.6542 10.7765 30.819 10.3179 31.7685 9.41354L31.9964 9.18426C33.7309 7.31184 33.6169 4.39495 31.7685 2.66264C30.8443 1.74554 29.5782 1.24877 28.2742 1.27425H22.8682V17.2471H24.9065ZM24.903 8.81474V3.2357H28.3219C29.0563 3.2357 29.7527 3.51592 30.2719 4.02543C31.3735 5.09538 31.3989 6.87864 30.3352 7.9868C29.816 8.53452 29.0816 8.84022 28.3219 8.81474H24.903ZM41.5046 7.17166C40.631 6.3692 39.4409 5.96159 37.9343 5.96159C35.9973 5.96159 34.5413 6.6749 33.5791 8.08876L35.3769 9.22241C36.0352 8.25435 36.9341 7.77033 38.0736 7.77033C38.7952 7.77033 39.4916 8.03781 40.036 8.52184C40.5677 8.98039 40.8716 9.64275 40.8716 10.3433V10.8146C40.0866 10.3815 39.0991 10.1522 37.8837 10.1522C36.4657 10.1522 35.3263 10.4834 34.478 11.1585C33.6297 11.8336 33.1993 12.7252 33.1993 13.8589C33.174 14.8906 33.6171 15.8714 34.402 16.5338C35.1996 17.2471 36.2125 17.6037 37.4026 17.6037C38.8079 17.6037 39.922 16.9796 40.7703 15.7313H40.8589V17.2471H42.8086V10.5089C42.8086 9.09503 42.3782 7.97413 41.5046 7.17166ZM35.9688 15.2346C35.5509 14.9289 35.2977 14.4321 35.2977 13.8971C35.2977 13.2985 35.5762 12.8017 36.1207 12.4068C36.6779 12.012 37.3743 11.8082 38.1974 11.8082C39.337 11.7954 40.2234 12.0502 40.8565 12.5597C40.8565 13.4258 40.5146 14.1773 39.8435 14.8142C39.2357 15.4256 38.4126 15.7695 37.5516 15.7695C36.9818 15.7823 36.4246 15.5912 35.9688 15.2346ZM47.1902 22.0491L54.0015 6.31824H51.7859L48.6335 14.1646H48.5955L45.367 6.31824H43.1515L47.6206 16.5465L45.0885 22.0491H47.1902Z"
                        fill="#3C4043"
                      />
                      <path
                        d="M17.8627 9.37543C17.8627 8.75129 17.812 8.12715 17.7107 7.51575H9.11426V11.044H14.0392C13.8366 12.1777 13.1783 13.1967 12.2161 13.8336V16.1263H15.1533C16.8752 14.5341 17.8627 12.1777 17.8627 9.37543Z"
                        fill="#4285F4"
                      />
                      <path
                        d="M9.11629 18.3427C11.5724 18.3427 13.6488 17.5275 15.1554 16.1264L12.2181 13.8336C11.3952 14.3941 10.3444 14.7125 9.11629 14.7125C6.73612 14.7125 4.7231 13.0948 4.00145 10.9294H0.975586V13.2986C2.52017 16.3939 5.67264 18.3427 9.11629 18.3427Z"
                        fill="#25D366"
                      />
                      <path
                        d="M4.00452 10.9294C3.62465 9.79574 3.62465 8.5602 4.00452 7.41382V5.05737H0.97818C-0.32606 7.64309 -0.32606 10.7001 0.97818 13.2858L4.00452 10.9294Z"
                        fill="#FBBC04"
                      />
                      <path
                        d="M9.11629 3.63075C10.4203 3.60528 11.6737 4.10204 12.6106 5.00641L15.2187 2.38248C13.5601 0.828495 11.3825 -0.0249207 9.11629 0.00055435C5.67264 0.00055435 2.52017 1.96214 0.975586 5.05736L4.00145 7.42654C4.7231 5.24842 6.73612 3.63075 9.11629 3.63075Z"
                        fill="#EA4335"
                      />
                    </svg>
                  </span>
                  <div className="card-text-america">
                    <div className="bank-america-text">Google Pay</div>
                  </div>
                </div>
              </div>
              <div className="form-check border-bottom px-0 custom-radio">
                <h2
                  className="connect-text not-connect"
                  onClick={toggleConnectionPay}
                  style={{
                    color: isConnectpay ? "#00D061" : "#FF484D",
                    cursor: "pointer",
                  }}
                >
                  {isConnectpay ? "Connected" : "Not Connected"}
                </h2>
                <div className="form-check-label checkout-modal-lbl-payment">
                  <span className="payment-type2">
                    <svg
            ...
            <div className="print-continue-btn-head">
              ...
              >
                <Link to="/bank_cards">Add New Payment</Link>
              </div>
            </div>
          </div>
        </div>
