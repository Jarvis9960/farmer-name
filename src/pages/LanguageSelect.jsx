      ...
      <div className="verification-main">
        <div className="container verify-screen-main p-0">
          <div className="back-btn back-btn2">
            <Link to="/finger_print_scan" onClick={handleBackClick}>
          ...
          <div className="verify-section-main align-items-stretch">
            <div className="main-text-group">
              <h2 className="hey-jessica">Hey, Jessica</h2>
              <p className="sub-text facilitate">
            ...
            <form className="select-lang-sec">
              <div className="lang-sec">
                <input
                  ...
                  checked={selectedLanguage === "select-lang1"}
              ...
              <div className="lang-sec">
                <input
                  ...
                  id="select-lang2"
                  name="select-language"
                  checked={selectedLanguage === "select-lang2"}
                  onChange={handleChange}
                />
                <label
              ...
              <div className="lang-sec">
                <input
                  ...
                  id="select-lang3"
                  name="select-language"
                  checked={selectedLanguage === "select-lang3"}
                  onChange={handleChange}
                />
                <label
                  className="custom-radio-sel-lang "
                  htmlFor="select-lang3"
                >
                  Hindi
                </label>
              </div>
              <div className="lang-sec">
                <input
                  ...
                  id="select-lang4"
                  name="select-language"
                  checked={selectedLanguage === "select-lang4"}
                  onChange={handleChange}
                />
                <label
                  className="custom-radio-sel-lang "
                  htmlFor="select-lang4"
                >
                  Portuguese
                </label>
              </div>
              <div className="lang-sec">
                <input
                  ...
                  id="select-lang5"
                  name="select-language"
                  checked={selectedLanguage === "select-lang5"}
                  onChange={handleChange}
                />
                <label
                  className="custom-radio-sel-lang "
                  htmlFor="select-lang5"
                >
                  Spanish
                </label>
              </div>
              <div className="lang-sec">
                <input
                  ...
                  id="select-lang6"
                  name="select-language"
                  checked={selectedLanguage === "select-lang6"}
                  onChange={handleChange}
                />
                <label
                  className="custom-radio-sel-lang "
                  htmlFor="select-lang6"
                >
                  Arabic
                </label>
              </div>
              <div className="lang-sec">
                <input
                  ...
                  id="select-lang7"
                  name="select-language"
                  checked={selectedLanguage === "select-lang7"}
                  onChange={handleChange}
                />
                <label
                  className="custom-radio-sel-lang "
                  htmlFor="select-lang7"
                >
                  Bulgarian
                </label>
              </div>
              <div className="lang-sec">
                <input
                  ...
                  id="select-lang8"
                  name="select-language"
                  checked={selectedLanguage === "select-lang8"}
                  onChange={handleChange}
                />
                <label
                  className="custom-radio-sel-lang "
                  htmlFor="select-lang8"
                >
                  French
                </label>
              </div>
              <div className="lang-sec">
                <input
                  ...
                  id="select-lang9"
                  name="select-language"
                  checked={selectedLanguage === "select-lang9"}
                  onChange={handleChange}
                />
                <label
                  className="custom-radio-sel-lang "
                  htmlFor="select-lang9"
                >
                  Russian
                </label>
              </div>
            ...
            <div className="finger-print-sec-btn">
              <div className="finger-print-sec-btn-wrapp laguage-bottom-buttons">
                <div className="print-skip-btn">
                  <Link to="/choose_interests">Skip</Link>
                </div>
                <div className="print-next-btn">
                  <Link to="/choose_interests">Next</Link>
                </div>
              </div>
            </div>
          </div>
